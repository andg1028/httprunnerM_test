...
BROKER_URL = 'amqp://dev:fubei@127.0.0.1:5672//' if DEBUG else 'amqp://dev:fubei@127.0.0.1:5672//'
...
EMAIL_SEND_USERNAME = 'fubei@fanhaoyue.com'  # 定时任务报告发送邮箱，支持163,qq,sina,企业qq邮箱等，注意需要开通smtp服务
EMAIL_SEND_PASSWORD = 'WA2meinv!'     # 邮箱密码
